...
d3.gantt = function() {
  ...
  var tip = d3.tip()
    ...
    .html(function(d) {
      ...
      if (d.runId.indexOf('.') > 0 )
          runId_format=d.runId.substr(0,d.runId.indexOf('.'));
      else 
          runId_format=d.runId
  ...
  gantt.yAxisLeftOffset = function(value) {
    if (!arguments.length)
      return yAxisLeftOffset;
    yAxisLeftOffset = value;
    return gantt;
  };
